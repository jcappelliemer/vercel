...
module.exports = function handler(req, res) {
  ...
  const body = [
    ...
    `- Servizi: ${origin}/servizi/`,
    `- Pellicole antisolari: ${origin}/servizi/pellicole-antisolari/`,
    `- Pellicole di sicurezza: ${origin}/servizi/pellicole-sicurezza/`,
    `- SafetyShield 800: ${origin}/prodotti/madico-safetyshield-800/`,
    `- Privacy e decorative: ${origin}/servizi/pellicole-decorative/`,
    `- Prodotti: ${origin}/prodotti/`,
