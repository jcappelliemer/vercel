...
const defaults = {
  ...
  hero_image: '/assets/generated/home/hero-architectural.webp',
...
const resolveAsset = (asset, fallback, legacyPaths = []) => (
  asset && !legacyPaths.includes(asset) ? asset : fallback
);
...
const normalizeSettings = (value = {}) => ({
  ...
  stat2_value: '+45k',
  footer_text: 'Distributore esclusivo MADICO USA per l\'Italia. 30+ anni di esperienza, +45k edifici trattati.',
  logo_url: resolveAsset(value.logo_url, '/assets/solaris-logo.png', ['/wp-data/images/logo.png']),
  hero_image: resolveAsset(value.hero_image, '/assets/generated/home/hero-architectural.webp', ['/wp-data/images/hero.jpg']),
});
